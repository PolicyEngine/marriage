...
export const PROGRAM_DESCRIPTIONS = {
  ...
  "Childcare costs": "Annual cost before assistance. Deducted once from net income; childcare assistance is included in benefits.",
  "Childcare assistance (CCDF)": "Modeled state childcare subsidy, assuming assistance is available if eligible. Included once in benefits. Waiting lists and local funding availability are not modeled.",
